...
using static HCB.Japanese.Converters;
...
/// </summary>
public static class Typer2
{
    #region Dictionaries


    public static readonly Dictionary<string, string> toHiragana = new(new KeyValuePair<string, string>[]
        {
            new("a","あ"),
            new("i","い"),
            new("u","う"),
    ...
    public static readonly Dictionary<string, string> toKatakana = new(new KeyValuePair<string, string>[]
        {
            new("a","ア"),
            new("i","イ"),
            new("u","ウ"),
    ...
    public static Dictionary<string, string> fromKanaLookup = new(new KeyValuePair<string, string>[]
        {
            new("あ", "a"),
            new("い", "i"),
            new("う", "u"),
    ...
    public static Word[][] SeparateSentenceV2(string KanjiString)
    {
        ...
        var likelyTokens = KanjiString.AsParallel().Select((firstChar, i) =>
        {
            ...
            for (var length = 1; true; length++)
            {
                ...
                var isKana = Kana.IsKana(searchString);
